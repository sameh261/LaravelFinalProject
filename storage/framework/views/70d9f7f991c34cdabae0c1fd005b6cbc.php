        ...
        <div class="form-register">
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="email" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>"
                        required />
...
<?php /**PATH C:\laragon\www\LaravelFinalProject\resources\views/auth/register.blade.php ENDPATH**/ ?>